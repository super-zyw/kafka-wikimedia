"""
Async commit
    set the enable.auto.commit = True
    then store offset in cache --> consumer.store_offsets(msg), the offset will commit periodically
    commit before exist
"""
...
config = config_obj.read('config/onfig.ini')
    ...
    while True:
        ...
        if msg.error():
            ...
            try:
                ...
                print(f"error offset: {msg.offset()}: {e}")
